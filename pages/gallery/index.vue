  ...
  >
    ...
    <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
      <div v-for="obj in galleryResponse.results" :key="obj.id">
        <a :href="`/gallery/${obj.slug}`">
          <div v-for="item in obj.images" :key="item.id">
            <div
            ...
            >
              <img
                class="object-cover w-full h-32 md:h-64 xl:h-80"
                :src="item.image.list"
                alt="Person"
              />
              <div
...
<script setup>
const { data: galleryResponse } = useFetch('http://127.0.0.1:8000/gallery/')
</script>
