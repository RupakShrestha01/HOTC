<template>
  <div class="relative mt-12 bg-blue-500">
    ...
    >
      <div class="grid gap-16 row-gap-10 mb-2 lg:grid-cols-6">
        <div class="md:max-w-md lg:col-span-2">
          ...
          >
            <img
              ...
              alt=""
            />
            <span class="ml-2 font-normal tracking-wide text-gray-100 uppercase"
      ...
      >
        <p class="text-sm text-gray-100">
          Copyright © - SDNTC - 2022 | Developed by Awecode | Check email
        </p>
